...
export const LogoutIcon = () => {
    return (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#000" fill="none">
...
const NavBar = () => {
    ...
    return(
        <>
        <div className="flex flex-row bg-white/60 backdrop-blur-md p-6">
